...
| C2 | **No / incomplete verification** (MAST 3.2) | "Looks good" | Fixed external acceptance suite, written before the run, run by deterministic code (ADR-003) | 🟡 step 7 (stage + artifact + events exist; suite runner pending) |
